...
def train_local(i, epoch, batch, id_1, id_2, losses):
        ...
        up_transform = T.Resize(size = (8,8))
        loss_GAN_1_Y = criterion_GAN(up_transform(D[id_1](fake_Y1)),valid)
        loss_GAN_1_Z = criterion_GAN(up_transform(D[id_1](fake_Z1)),valid)
        ...
        loss_GAN_2_Y = criterion_GAN(up_transform(D[id_2](fake_Y2)),valid)
        loss_GAN_2_Z = criterion_GAN(up_transform(D[id_2](fake_Z2)),valid)
