...
def train_local(i, epoch, batch, id_1, id_2, losses):
        ...
        # Reconstruct speech
        recon_X1,recon_Y1,recon_Z1 = G[id_1](Z1)
        recon_X2,recon_Y2,recon_Z2 = G[id_2](Z2)



        # Translate speech
        fake_X1,fake_Y1,fake_Z1 = G[id_1](Z2)
        fake_X2,fake_Y2,fake_Z2 = G[id_2](Z1)
        ...
        cycle_X1,cycle_Y1,cycle_Z1 = G[id_1](Z2_)
        cycle_X2,cycle_Y2,cycle_Z2 = G[id_2](Z1_)
        ...
        weighted_loss_GAN_1_y = 0.25*(loss_GAN_1_Y)
        weighted_loss_GAN_1_z = 0.25*(loss_GAN_1_Z)
        

        loss_GAN_1 = lambda_0 * (weighted_loss_GAN_1_x+weighted_loss_GAN_1_y+weighted_loss_GAN_1_z)
        ...
        weighted_loss_GAN_2_y = 0.25*(loss_GAN_2_Y)
        weighted_loss_GAN_2_z = 0.25*(loss_GAN_2_Z)
        

        loss_GAN_2 = lambda_0 * (weighted_loss_GAN_2_x+weighted_loss_GAN_2_y+weighted_loss_GAN_2_z)
